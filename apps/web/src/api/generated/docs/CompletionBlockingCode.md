...
* `PendingChangeProposals` (value: `'pending_change_proposals'`)
...
* `StaleEvidence` (value: `'stale_evidence'`)

* `ApprovalWorkflowMissing` (value: `'approval_workflow_missing'`)

* `ApprovalStepsIncomplete` (value: `'approval_steps_incomplete'`)

* `DocumentAlreadyCompleted` (value: `'document_already_completed'`)
